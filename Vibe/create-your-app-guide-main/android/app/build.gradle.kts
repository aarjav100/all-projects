...
android {
    ...
    defaultConfig {
        ...
        // Load Supabase credentials from local.properties (optional)
        val localPropertiesFile = rootProject.file("local.properties")
        val supabaseUrl = if (localPropertiesFile.exists()) {
            val properties = java.util.Properties()
            properties.load(localPropertiesFile.inputStream())
            properties.getProperty("SUPABASE_URL", "https://placeholder.supabase.co")
        } else {
        ...
        val supabaseKey = if (localPropertiesFile.exists()) {
            val properties = java.util.Properties()
            properties.load(localPropertiesFile.inputStream())
            properties.getProperty("SUPABASE_ANON_KEY", "placeholder-key")
        } else {
            "placeholder-key"
        }
