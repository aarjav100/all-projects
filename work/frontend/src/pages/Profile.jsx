  ...
  return (
    <div className="flex flex-col gap-8 pb-16">
      <div className="flex justify-between items-center">
        ...
        <button onClick={fetchProfileData} className="text-slate-450 hover:text-slate-650 flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider">
          <RefreshCw size={10} /> Sync Stats
        </button>
      </div>
