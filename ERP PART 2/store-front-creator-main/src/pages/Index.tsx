  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-4">Welcome to BriskKart</h1>
          <p className="text-xl text-muted-foreground mb-6">Discover amazing products at unbeatable prices</p>
